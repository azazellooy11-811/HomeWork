        ...
        launch {
            ...
            broadcast.consumeEach {
                ...
                lastTimeout = launch {
                    ...
                    try {
                        val replication = withContext(Dispatchers.IO) {
                            service.weatherByName(it)
                        }
                        goToItem(replication.id)
    ...
    private fun getWeatherNear() {
        launch {
            ...
            val response = withContext(Dispatchers.IO) {
                service.weatherCitiesInCycle(breadth, length,
                    Utils.COUNT_WEATHER_CIRCLE
                )
            }
            ...
            rv_cities.adapter =
                CityAdapter(response.list as MutableList<WeatherResponse>) {
                    goToItem(it)
                }
        }
    }
